...
import AIAgentSandboxPage from "./features/ai-agent/pages/AIAgentSandboxPage.jsx";
...
const RAW_MODULES = [
  ...
  },
  {
    icon: Sparkles,
    label: "AI Agent 沙箱页面",
    pageId: "ai-agent-sandbox",
    description: "整合 AegisAgent 的上传、扫描、执行与报告展示能力，构成新的 AI Agent 前端入口。",
    status: "新增页面",
  },
];
...
export default function App() {
  ...
  if (activePage === "ai-agent-sandbox") {
    return <AIAgentSandboxPage />;
  }
